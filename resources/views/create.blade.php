...
<div class="container-fluid"> 
  <div class="row"> 
	...
	{{ csrf_field() }}
		...
		<input class ="form-control" type="text" name="cnpj_cpf" id="cnpj_cpf">
		<label for="fundacao">Fundação/Aniversário</label>
		<input class ="form-control" type="text" name="fundacao" id="fundacao">
